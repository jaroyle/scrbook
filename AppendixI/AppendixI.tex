...
\mbox{\tt maptools} \citep{bivand_levin-koh:2013} is a library of maps. Manual at \url{''http://cran.r-project.org/web/packages/maps/index.html''}. 
...
\mbox{\tt maptools} \citep{lewin-koh_etal:2011} provides a set of tools for reading and manipulating spatial data, especially ESRI shapefiles. Manual at \url{''http://cran.r-project.org/web/packages/maptools/maptools.pdf''}. 
 ...
 {\flushleft \tt mvtnorm}:
\mbox{\tt mvtnorm} \citep{genz_etal:2012} XXXXX. Manual at \url{http://cran.r-project.org/web/packages/mvtnorm/mvtnorm.pdf}. 
