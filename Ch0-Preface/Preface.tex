...
application of capture-recapture (CR)
...
capture-recapture (SCR) models over the last several years, and interest in
these models to answer questions of basic and applied ecology and
conservation has
increased dramatically over this period.  Our purpose in writing this book is to bring
together all of the developments over the last few years and give
researchers
 practical options for analyzing their own data using the large
...
models, or SECR) are a relatively new invention that stand to revolutionize how
...
to animal population and landscape ecology, wildlife management and conservation. With such advanced tools at hand,
...
SCR.  There are a lot of books out thefre that cover spatial
...
analyses.  There are some great books out there including Bolker
...
(Chapt. \ref{chapt.gof}), and 
 sampling design
(Chapt. \ref{chapt.design}).     XXXXXXXXXXX WHATS MISSING HERE ?
XXXXXXXX 
...
The finally conceptual 4th of this book is what we call
