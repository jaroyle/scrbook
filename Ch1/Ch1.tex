...
fundamental population processes.
At the
...
capture-recapture methods \citep{seber:1982,williams_etal:2002}.
However, despite the central roll of space and spatial processes to both
understanding population dynamics and how we observe populations, a
...
Capture-recapture.....methods for inference about population size and
vital rates.  Classical methods are not spatially explicit which
causes many problems. While this has been recobnized for decades (REF
XXXX), it has only been very recently (cite XXXX) that CR models have
been developed that accomodate space . So-called spatial
