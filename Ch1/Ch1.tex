...
Need subsection somewhere on: Spatial processes in animal populations......
XXX This is all about motive -- should not be about fixing technical
problems
with existing estimators but , rather, modeling actual ecological
processes.
XXXX Somewhere in here we need to identify the relevant ecological
problems related to the spatial
aspects
of studying animal populations: MOVEMENT, SPACE-USAGE, SPATIAL VARIATION
IN DENSITY  
XXXXX
XXXXX
-- most population processes have a spatial component and ignoring it
...
<<<<<<< HEAD
number of useful directions, including to accommodate unmarked individuals
...
>>>>>>> 1b8e0f4d91e48fb2661b7c8ab17aa899620bb75d
...
\end{center}
\caption{
Left: Wolverine in camera trap from (thanks: Audrey Magoun).
Right: Tiger encountered by 
camera trap (thanks:  Ullas Karanth/WCS).
}
...
\end{center}
<<<<<<< HEAD
\caption{Black bear in a hair snare from M. Wegan (left). European wildcat from XXXMarc's friendXX
  (right). }
=======
\caption{Picture of hair snare. Bear (left). 
...
Photos provided by Craig Thompson, USDA Forest Service,
...
array. The historical context is succinctly put by \citep{obrien:2011}
...
(3) Ordinary CR models do not accommodate trap-level covariates which
 exist in a large proportion of real studies. 
...
\end{center}
\caption{Locations of hair snares targeting black bears on Fort Drum.}
...
estimated for our study region to be $2.19$
km \citep{wegan:2008} \footnote{Is this number right out of Wegan's dissertation? XX Yes, his thesis XX}, and
...
to question whether $p$ is truly constant. Naturally, one
