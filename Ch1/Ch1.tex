...
deficiencies of non-spatial methods, namely, traditional CR
methods do not allow one to estimate density, do not allow for the
inclusion of trap-level covariates, and do not account for
...
\subsection{Conceptual Scope of this Book}
