...
Points is that N has to scale, as part of the model, with area. Area has to be a biological thing integrated
with the model. Scaling of N has to be a feature of the model. 
