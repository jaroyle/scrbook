...
more interesting than the previous non-hierarchical model.  On the
other hand, suppose we havve some meaningful group structure in this
...
$i$ and $z_{i}=0$ if not).  This model is has an important conceptual
...
and also maximum likelihood, for which we also use the R
