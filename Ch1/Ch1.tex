...
deficiencies of traditional, non-spatial CR methods. Specifically,
historical methods do not allow one to
\begin{itemize}
  \item[(1)] estimate density
  \item[(2)] include of trap-level covariates of density or capture probability
  \item[(3)] account for heterogeneity in encounter probability that
...
than 70 years \citep{dice:1938}. Before discussing how SCR resolves
