...
theory.  At the same time, SCR models can be used, and may be the only
option, for obtaining baseline data on some of the rarest and most
elusive species -- information which is required for effective
conservation.  Their potential for advancing both applied and
theoretical research has not been fully realized, which is one reason
we were compelled to write this book.
