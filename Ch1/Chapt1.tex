...
spatial processes such as spatial organization of individuals,
 variation in density, movement,
resource selection, and space usage.  As we will see, this allows us
to overcome critical deficiencies of non-spatial methods, integrate
ecological theory with encounter history data, and therefore greatly
...
this as a {\it spatial encounter history} and, historically, the
spatial information has been ignored, the data have been {\it
  summarized} to simple ``encounter or not'' for the purpose of
applying ordinary CR models.
The basic problem with conventional (''non-spatial'')
...
space usage, etc.....  And models just resort to modeling ``encounter
probability'' which is a nuisance parameter taht is seldom of any
...
{\it both} movement and density simultanesouly
...
space usage (e.g., Chapt. \ref{chapt.rsf}), landsape connectivity
...
SCR models provide a holistic framework for studing animal populations
