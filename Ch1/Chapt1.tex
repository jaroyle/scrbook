...
are important in the management of populations, and movement, dispersal,
and % RC added this XXXX
...
for decades \citep{hayne:1950}, %XXXX, Was this meant to be in there?
it has only been very recently
...
theory.
% SUGGEST ADDING SOMETHING LIKE: At the same time, SCR models can be
...
% MAYBE GO ON TO SAY SOMETHING LIKE: Their potential for advancing both
...
CR models do not provide a coherent basis for estimating density, a
problem we struggled with in the black bear study.
...
studies;
(4) Ordinary CR models do not accommodate formal
...
individual encounter history data, and
 for studying animal populations processes such as
