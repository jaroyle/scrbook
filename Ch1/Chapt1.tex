...
are necessary in the conservation and management of populations.
...
using individual encounter data that exhibit various biases relating to the
...
model. They differ
%are, rather, just different in what
primarily in terms of the ecological focus. % is.
...
population.  %Many movement modeling applications seem to focus on
%``what is this individual doing in relation to the space it has
%available'' and there is no formal attempt
%to extrapolate a sample to the population.
That said, there are
