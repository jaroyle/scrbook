...
examples, understanding distribution or spatial variation in density
...
population dynamics and how we observe or sample populations, a
coherent framework that integrates these two aspects has not been
fully realized either conceptually or methodologically.
...
technique. Rather, they represent a much more profound extneion in
...
on the location of capture, are {\it spatial
  encounter histories}. Such information is informative about
...
related to spatial population processes.
In turn, this greatly 
...
Historically, 
people try to reduce spatial heterogeneity in capture probability by
...
are not integrated with any ecological theory. Gold fish in a bowl,
words in a book, etc... XXXXXXXXXXXXXXXXXXXXX
...
equally well to estimating the number of unique words in a book, 
the size of some population that exists in a computer,
or a bucket full of goldfish.  The question
...
in a book, or goldfish in a bowl, or tigers in a patch of forest! That
...
space is central to so many real problems, this is probably the number
1 
reason that many ecologists don't bother with capture-recapture. They
haven't seen capture-recapture methods as being able to solve their problems. 
...
Rather, we imagine these to be the centroid of individuals home
ranges, or the 
...
models. However, there are many more aspects relevant to the
formulation of SCR models for specific situations. We address various
of these things in later chapters. One important distinction ...
...
models.  Rather, they provide a coherent, flexible
...
promise the ability to integrate explicit ecological
...
SCR models provide 
a holistic framework for studing animal populations -- individual movement,
resource selection or space usage, population dynamics, and density. Historically these things are all
studied independently, using ostensibly unrelated study designs and
statistical procedures. For example, resource selection function (RSF)
models for resource selection,
state-space models for movement, density using closed
capture-recapture methods, and population dynamics with various
``open'' capture-recapture models. 
SCR can bring all of these problems together into a single
