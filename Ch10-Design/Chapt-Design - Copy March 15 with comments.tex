...
exposed to capture.  
%By seeking to minimize the variance of an
%estimator of $N$, our objective function represents a compromise
...
easier here (but is not necessary, in general). 
\end{comment}
...
%.  In particular, if we knew the activity centers of
...
points(a2.1$Xlst[[1]],pch="X",col="red") crit 5 = Var(N)  Q2
points(a3.1$Xlst[[1]],pch="0")  crit 6 = 1 -pbar     Q3
points(a4.1$Xlst[[1]],pch="*")  crit 7 = var(pbar)   Q4
