...
entire home range \citep{otis_etal:1978}.
...
ocelots. % XXXX What's our policy on scientific names?
...
individuals,
gross recaptures % XXXX RBC says: suggest removing or rephrasing
                 % "gross recaptures"
...
regular spacing of 2 units, using a Binomial % XXXX or binomial?
...
Estimates % XXXX Posterior point estimates?
...
rrmse % XXXX CAPS? RRMSE?
and relative bias for the estimates of $N$. Figure
\ref{design.fig.rmse} shows the results of this set of simulations. We
see that there is clearly an optimum % XXXX optimal?
trap spacing, especially in terms
of precision, which is highest at a trap spacing of $1.5 - 2.5 \times
\sigma$. \citet{efford:2012wbbw} %found %find
%the same relationship between
%trap spacing and precision in estimates of density. He showed %shows
reported similar results and highlighted the
%that
%there is a
trade-off between the number of individuals captured % we capture
and
the number of spatial recpatures %times we recapture those individuals in different traps
...
%allowed for differences in the
...
% XXXX RBS says: In what way is this "final"?
...
in theory, %-
adequately estimated density and home range size. However,
...
% XXXX RBC says: If we don't have any results to show, then perhaps
% this should be moved to the Summary and Outlook section. It seems
...
% XXXX have we used the term "distance coefficient parameter" before?
