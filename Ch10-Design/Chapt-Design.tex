...
cluster to rotating design, although with a relatively minor loss of
efficiency in using the cluster design. The result seems to support
that cluster designs can be effective with relatively little loss of efficiency.

Further 
research on optimal detector configurations
...
discussed SCR models that integrate auxiliary information on resource
...
available. With the {\bf R} code we provided in
