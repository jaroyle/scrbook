...
and (4) an SCR model, and (5) a design criterion $Q({\bf
...
As an alternative to both of those approaches,
we instead adopt an
approach where we devise
a variance criteria based on % XXXX or criterion?
...
\end{equation}
This is a really intuitive-looking criterion % XXXX Maybe to you!
upon which to base
...
$\lambda({\bf x},{\bf s})*D({\bf s})$ % XXXX In Ch11 I use $\mu({\bf
