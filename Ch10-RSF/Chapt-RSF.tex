...
Telemetry data is really important.... can provide information about
space usage and direct information about $\sigma$ and so forth..... we
need to integrate that information into SCR models... Rahel papers
here .....
...
In this chapter, following \citet{royle_etal:2012rsf}, we extend our notion of encounter probability models
...
Benefits of integrating telemetry data:
...
\[
 \log(\lambda_{ij}) = \log(\phi_{0}) + a_{0} -\alpha_{1} D_{ij}^{2} +  \alpha_{2} z({\bf x}).
\]
We combine the constants so that $\alpha_{0} = \log(\phi_{0}) +
a_{0}$ is the
...
The Bernoulli observation model implies that the observed encounter frequencies 
for individual $i$ and trap $j$,
