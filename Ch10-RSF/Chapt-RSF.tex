...
%The formulation of the model is unaffected by
...
quality.
% RBC commented this out because habitat.png was not available
\begin{figure}
\centering
...
Thus, the model of space usage induces the following 
