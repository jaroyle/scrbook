...
%% cost-distances
%% between the pixels
sqrt(2) units= 1.414214, the shortest distance between pixels 13 and 14 is 100
units, while the shortest cost-distance between 13 and 15 is 150.5. A
tough one is: what is the shortest distance between 10 and 16? A guy at pixel
10 can move diagonal and pay  $(sqrt((100+1)*((100+1)/2)))+1 =72.41778$
