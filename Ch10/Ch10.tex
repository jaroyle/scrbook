...
\citep{shirk_etal:2010},  range limitations
\citep{mcrae_beier:2007}, or distance from urban areas, highways, human disturbance
or other factors that animals might avoid.  Together multiple environmental variables
...
likelihood which we address below. This allows us to formally model these factors
that influence space usage, and test explicit hypotheses about these things using
only individual level encounter history data from capture-recapture studies.
...
we can compare a set of models directly by likelihood. It turns out, for this class
...
Cost has to be a raster..... show creating a cost raster right here


Here is a modification of our integrated likelihood routine........
...
Purpose is to show more GIS type stuff for another prototypical situation.

like a hard boundary --  a lake or city or something......
we could either have individuals living in this buffered area or outside of it.....
