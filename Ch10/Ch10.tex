...
costs1<- c(100,1,1,1,100,100,1,1,100,100,100,1,100,100,1,1)
values(r)<-matrix(costs1,4,4,byrow=TRUE)  
par(mfrow=c(1,1))
plot(r)
\end{verbatim}
...
\end{verbatim}
1%above is output with directions=4
}
...
%above is output with directions=8 


\begin{comment}

I wanted an example here of a case where the least-cost path
was not equal to the least euclidean distance path
