...
structure..... and it implies that space usage of indivdiuals is
...
will deterimine the character of its usage of space. In particular, we
...
this new model; (2) the effect of misspecifying the model with a
...
misspecifiedeuclidean distance model; (ii) the true data-generating
