...
The critical consideration that motivates our work is that the
...
stationary, isotropic and symmetric. We expect this to be unreasonable in
some  applications. 
...
information about the landscape so that a unit of distance is
spatially variable
...
will determine the character of its usage of space and its individual encounter
rate in traps. In particular, we
suggest a distance metric that implies irregular, asymmetric and
