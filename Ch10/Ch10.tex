...
%the literature,
T main problem with the normal Euclidean distance metric, i.e., $
...
Fig. \ref{fig.homeranges} shows home ranges of 6 individuals
...
To compute the cost distance we prescribe a set of points, or XXX we
can compute it XXX between
