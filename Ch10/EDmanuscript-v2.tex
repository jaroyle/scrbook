...
\begin{comment}
Moreover, in studies of landscape connectivity, when data on dispersal
and gene flow does not exist, practicioners have used other data,
including simple occupancy or RSFs to parameterize corridor designs.
Use of estimates from our approach requires only the assumption that
animals movement is similarly impacted by the landscape during home
