...
\begin{flushleft}
{\em \bf Abstract}
Asssessing the impacts of habitat fragmentation and habitat loss on connectivity
...
resistence to movement are key determinants of connectivity, yet no methods exist for
...
formal methods exist for estimating resistence
...
and landscape resistence on population viability \citep{cushman_etal:2010}.

Even when landscape resistence is not of direct interest, inference
...
\begin{comment}
%directly relevant to standard data collected from such studies.
...
hypotheses about how environmental variables affect the movement can
be evaluated.
\begin{comment}
distance
