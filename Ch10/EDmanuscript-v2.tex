...
\begin{flushleft}
{\em \bf Abstract}
To assess of the impacts of anthropogenic disturbances such as habitat
fragmentation, ecologists require robust models for inference about
...
and mobile species, neither objective is easily met. This is due in part to the
fact that no formal methods exist for simultaneously estimating population
density and connectivity. As a result, ecologists often rely on expert
opinion and other \textit{ad hoc} methods for addressing these
important issues.

Capture-recapture models are arguably the most important class of
methods for estimating population size of rare species
