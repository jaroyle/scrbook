...
In spite of the utility of SCR models for estimating population density, these
methods are still in their
infancy and every application of %SCR models
so far has been based on capture %encounter
...
using Euclidean distance, imagine a large forest patch fragmented
% study area bisected
