...
A key practical detail is that the likelihood here is formulation in
...
\end{center}
\caption{
Typical space usage of 4 individuals based on the cost surface shown in
  Fig. \ref{ecoldist.fig.raster100}. Black dots indicates the home
  range center and the pixels around each home range center are shaded
according to the probability of encounter.
}
...
\end{tabular}
\caption{Two landscape covariates used for simulations. A hypothetical
  realization of $N=100$ activity centers is superimposed on the left,
along with 16 trap locations. }
