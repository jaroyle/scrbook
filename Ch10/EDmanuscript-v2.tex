...
objectives are typically addressed independently and often using \textit{ad hoc}
...
for assessing how landscape change, such as habitat fragmentation, affects
population density and landscape connectivity. Although many methods
exist for estimating population density, most models do not allow for
movement (i.e. they assume geographic closure). In contrast, and in
spite of widespread recognition of the importance of landscape
connectivity for maintaining population viability, rarely has
connectivity been estimated from empirical data, and never has it been
estimated simulaneously with population density. Rather,
%as determined by animal
%movement. Although  \citep{ricketts:2001}. For many rare, elusive,
...
%density and connectivity. As a result,
ecologists often rely on expert
opinion and various \textit{ad hoc} approaches for describing
connectivity \citep{zeller_etal:2012}.
