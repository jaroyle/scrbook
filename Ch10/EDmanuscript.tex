...
moderate small sample bias of 3-5\% in the MLE of $N$ which becomes
marginal as $K$ increases. For $N=200$ the bias is on the order of 2\%
for the lowest sample size case ($K=3$) but negligible otherwise.
