...
\label{eq.lcp}
\end{equation}
Calculation of the least-cost path is done
in some GIS packages and also in the {\bf R} package \mbox{\tt
...
including the {\bf R} package \mbox{\tt
  costdistance} \citep{vanetten:2011}. To use that package (see
below), we define the incremental cost of moving
...
spatial capture-recapture model (Appendix 1).
