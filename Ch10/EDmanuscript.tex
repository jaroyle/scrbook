...
already becoming widespread \citep{efford_etal:2009,
  gardner_etal:2010, kery_etal:2010, 
...
\centering
\caption{
Mean of sampling distn of $\theta_{2}$ for the different simulation
conditions. 
}
...
(Table \ref{tab.results1}) that the MLE of model parameters is
