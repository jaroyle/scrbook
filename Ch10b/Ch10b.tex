...
RSF only       NA  NA   0.98  0.22  2.00  0.119

n=8
SCR only    99.59 10.00  1.00  0.13  1.9984966  0.1297490
SCR/RSF     98.90 10.02  0.99  0.10  2.00479788  0.07139757
sbar        96.07 10.37  0.84  0.19  1.96465528  0.07817228
RSF only      NA   NA    0.98  0.16  2.00691784 0.08412492
...
n=16
SCR only 99.2275209 10.7351407  0.9933914  0.1434025  1.9992220  0.1279683
SCR/RSF  99.19559725  9.79003837  0.99610492  0.08644984  1.99448886  0.05661761
sbar     95.10217773 10.16919035  0.79620129  0.21854275  1.94925123  0.07461257
RSF only      NA        NA 0.9962658 0.1034136 1.9933405 0.0608341
\end{verbatim}

The replicate runs of SCR only give us an idea of the inherent MC
error in these simulations. About 0.5 units.

There is a small persistent bias of $< 1\%$ in the MLE of $N$ in
general, and as much as 2-4\% when ${\bf s}$ is estimated by the
average observed location. 
In general we expect a small amount of bias in MLEs as they are only
known to be asymptotically unbiased so our typical sample sizes of
61 individuals on average aint that great.
 Moreover, the raster is fairly coarse relative to $\sigma$ in our study, having a 1
km resolution whereas $\sigma = 2$, which we expect to introduce a small amount of negative
bias because it is an explicit under-statement of the true
heterogeneity in $p$ due to the spatial context of the problem. 
