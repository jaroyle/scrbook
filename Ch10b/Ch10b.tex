...
structure (Fig. \ref{rsf.fig.habitat}). 
\begin{figure}
\centering
...
Poisson and that model will produce biased eestimators.
...
space or resource use, that is consisttent with existing views of
...
controling ``home range radius'', is also directly estimable from
...
sampling bias in the individuals that are telmetered. In addition,
