...
models such as the bivariate normal distribution, which imply
...
home range size shape are often not well represented by stationary
distributions, and thus
more complex models of the encounter %detection
process that relate to how individuals use space are needed.
 In this paper,
...
latter point, we can think of the two
