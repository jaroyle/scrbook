...
SCR data to study space usage and resource selection have been proposed.
Indeed no methods exist for simultaneously modeling
space usage, resource selection, and population density.
In this paper we devise such a method by developing a statistical framework for
