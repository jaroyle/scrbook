...
$\mathcal{S}$, and each individual has an activity center,
with Cartesian coordinates $\mathbf{s}_i (i=1,\ldots,N$),
about which movement occurs during some time interval. The population
