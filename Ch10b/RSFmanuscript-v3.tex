...
\noindent Catherine C.  Sun, Dept. of Natural Resources, Cornell
University, Ithaca, NY, 
\emph{email:} catherine.c.sun@gmail.com \\

\noindent Angela K. Fuller, Dept. of Natural Resources, Cornell
University, Ithaca, NY, 
...
use is the outcome of individuals moving around their home range \citep{aarts_etal:2008,johnson_etal:2008,forester_etal:2009,hooten_etal:2010},
...
affect on integration, raster size is itself an important practical
concern. 
...
effectively integrate the likelihood over the state-space of ${\bf
  s}$. In this case, too corse of a raster will likely cause biased
...
affects on computing and memory requirements.  Choice of raster size
...
telemetry data stream is thinned, as we did in our analysis of the
...
RSF movement model for correlated data from \citep{johnson_etal:2008}
should not pose any difficulty in terms of constructing the joint
