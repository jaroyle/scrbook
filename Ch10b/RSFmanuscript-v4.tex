...
see that the two models with elevation affecting density  are preferred -- and, there is a
...
that
the sign of the estimate of $\alpha_{2}$ changes from positive to
...
$\alpha_{2} = 1$ (the coefficient on the landscape covariate $z({\bf
  x})$). 
% In the absence of the covariate $z$, this corresponds to a
%%%RSF that is bivariate normal with standard deviation 2.  
These
