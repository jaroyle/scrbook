...
normalzing constant. In this case, the normalizing constant is found by integrating
...
methods are useful for accomodating overdispersion, but it seems unlikely that
