...
other model extensions. It is also worth remembering that the Poisson
distribution is the limit of the binomial distribution when, in this
case, $M$ is very high and $\phi$ is very low. In this case, there is
...
appear in the binomial model for $N$ shown above. Instead, have the
data augmentation parameter $\psi$,  which has been used throughout
this book. So, what is the relationship between $\psi$ and $\mu$?
...
spatially-referenced covariates. We conclude this section by pointing
