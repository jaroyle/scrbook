...
also consider the plausible case where a state-space covariate is also a
...
matrix of coordiantes for each pixel.
...
range size decreasing with habitat quality. To model this effect, we
...
is less than Euclidean distance (ED). In most cases, we would not expect,
...
area south of the Iguazu River, which jaguars rarely cross, and we
...
responses can be accomodated. Even more remarkable is the ability to
