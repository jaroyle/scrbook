...
underlying point process is not observed, meaning that we need an
observation model that describes how the observed data are result from
the . Thus, in SCR, we can simply add the methods described above into a likelihood
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{Ch11/figs/fm1p}
