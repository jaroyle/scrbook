...
has expressed encounter probability as a function of the Euclidean
...
% XXXX RC: Need to convert to grayscale. The blue and red dots will
% look the same otherwise. It might also be worth making the traps
% with points(..., pch="+").
}
...
% XXXX RC: Suggest removing verticle lines from tables for consistency
% XxXX Other annoying suggestions: Perhaps center the K=x statements
% using mulitcolumn, and capitalize euclid and lcp so they stand out.
\begin{table}[htp]
\label{tab.results1}
{\small
\caption{
...
% XXXX I think there is a typo in these sentence.
...
In the presence of functional landscape connectivity, misspecification
