...
% XXXX Say something about modeling movement directly. i.e. Right now
% we assume the capture locations are independent, conditional on
% s. But what if they are dependent upon previous capture location?
% This is how Ovaskainen does it I think.
