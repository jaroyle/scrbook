...
determine detection and survival probabilities.  
...
In this multi-state model approach, the movement is often parameterized
as random or Markovian between patches.
