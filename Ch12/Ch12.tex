...
\begin{figure}
\centering
\includegraphics[height=2in,width=2.5in]{Ch12/RobustDesign.pdf}
...
\]
Thus, if $z(i,1)=1$, then the individual may survive to time $t=2$ with
...
This suggests that the actual effective trapping area is smaller than our state space, but we cannot know how much relative to the state-space to make useful comparisons between the $N$s.   WSE51601
