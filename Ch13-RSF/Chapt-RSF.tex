...
although Boyce and McDonald (XXXXXX) describe a procedure where (an
...
this allows for the integration of axiliary data from telemetry
...
product of the two components. In
particular, let ${\cal L}_{scr}(\alpha_{0}, \alpha_{1}, \alpha_{2}, N;{\bf y})$
