...
this in the \mbox{\tt scrbook} package, see \mbox{\tt ?intlik3rsv}.
...
\end{itemize}
AIC for the first 4 models can be compared because they are nested
models. Also the last 2 can be compared with each other, but not with
the first 4, because those include telemetry data.  Parameter
estimates are shown in Table \ref{tab.nyresults} (from
\citet{royle_etal:2012mee}).  We provide a full {\bf R} script for
fitting all of these models to simulated data in the help file for
\mbox{\tt intlik3rsf}.
