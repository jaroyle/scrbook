...
\citep{borchers:2011}. %, and they provide a
...
devices, or if our telemetry apparatus %is imperfect such that
...
where
\[
 \pi({\bf x}_{g}|{\bf s}_{i})  = \frac{ \exp( -\alpha_{1} d_{ig}^{2} +\alpha_{2} z({\bf x}_{g}) ) }
{ \sum_{g} \exp(-\alpha_{1} d_{ig}^{2} +\alpha_{2} z({\bf x}_{g}))}
\]
...
\bibliography{RSFmanuscript-v2.bbl}
...
\begin{figure}
\centering
\includegraphics[width=3.5in,height=3.25in]{habitat.png}
...
\begin{figure}
\centering
\includegraphics[width=3.5in,height=3.5in]{homeranges8}
