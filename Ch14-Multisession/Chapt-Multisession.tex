...
Under this Poisson model, even with a constant mean $\lambda$, each
stratum or group may have a different realized population size. Thus,
...
The ideas described above for implementing Bayesian models for
stratified populations
are completely general, and can be applied equally to ordinary
...
is called \mbox{\tt ovenbird$\_$ms} which you can run to reproduce the
