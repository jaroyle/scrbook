...
Distance sampling \citep{buckland_etal:2001}, which we briefly introduced in Chapter~\ref{chapt.intro},
...
location multiple times during a season. But then you can expect animal
