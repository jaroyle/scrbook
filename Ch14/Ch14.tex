...
data simulated from the true model. The parula data superficially look
quite nice for purposes, and although the model yields sensible
results, posterior precision is quite low.

So why not just collect distance data or something? If you can, great,
we are not arguing against the use of other methods. However, this
model provides an important foundation for modeling data where other
methods do not apply. The potential generalizations are numerous as we
will see later in this chapter and in the next chapter.
