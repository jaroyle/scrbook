...
The ideal situation is where we have a continuous search-path or line,
...
%A situation in which this may be violated is
%when we set out the sampling route so as to maximize the number of
%individuals we observe based on our subject-matter knowledge of
%species-habitat associations. In addition, the use of roadside routes
%for sampling would probably be suspect.
%%%%
%sampling is
...
producing the transect, but does not affect the collection of data.
\end{comment}

 A number of variations of this search-encounter situation are possible,
...
In this we neglect to record a search line and also the locations of individuals
