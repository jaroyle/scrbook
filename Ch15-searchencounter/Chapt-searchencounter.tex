...
% XX RS: Not sure what you mean by observation device. Or do you mean by where in the larger area we sample?
...
% XX RS: Does p refer to baseline detection here? Reads like all individuals have the same p in the plot.
The data set
...
% XX RS: Maybe add something like '... and not affected by different search efforts in different parts of the polygon'
% Also, again, this is baseline detection, right?
