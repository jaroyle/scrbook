...
\subsection{A brief history of mark-resight models}
...
In this chapter we will consider mark-resight sampling in the framework of spatial capture-recapture. In non-spatial mark-resight models all information about model parameters comes from the marked individuals. In the spatial framework, this is true for most of the information on model parameters. But analogous to the models we saw in the previous Chapt. \ref{}, the spatial correlation in counts of unmarked individuals also contributes information about detection and movement. 
