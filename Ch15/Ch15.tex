...
population closure can be accomodated by some models) and no loss or
...
XXX general comment: instead of ``all-0'' please use ``all-zero'' XXX
...
‘population’ of samples is identifiable XXXX not sure of meaning
of this last thing... part of the sample? XXXXXX. This type of data
...
available that account for possible misidentification of individuals
XXX some literature on misidentification right? Cite one or two?
Link? Yoshizaki? XXXXX
and in this chapter we will ignore this kind of data and focus instead
