...
XXXXXXXX How confusing is the double use of u here (once as nomber of unmarked, once as this indicator vector)? XXXXXX
...
#Sk, lamk, Dk = activity centers, encounter rate matrix 
#and distance matrix of telemetry-tagged individuals 
...
for (ind in 1:ntot) {
  llsig[ind]<-sum(dmvnorm(x=locs[[ind]],mean=c(Sk[ind,1],Sk[ind,2]), 
				sigma=cbind(c(sigma^2,0), c(0,sigma^2)), log=T))   
  llsig.cand[ind]<-sum(dmvnorm(x=locs[[ind]],mean=c(Sk[ind,1],Sk[ind,2]), 
