...
migratory fishes.  
 The
data were collected and analyzed in \citet{raabe_diss:2012}.  Using a
...
forumation of the model, the state-transition
...
$\psi^{BA}$ is very high, indicating that fish in this study are
...
where $\lambda_{0}$ is the baseline encounter rate and $g_{ij}$ is the detection model as function
of distance.
If the
...
\citep{ovaskainen_etal:2008}.  In addition to that, determining if
