...
than the homogeneous Binomial point process (``uniformity of density'') which underlies the basic
 ...
 \ref {chapt.state-space} you already saw an example of an inhomogeneous point process model -- one implementable in {\bf JAGS} -- and we briefly introduce a different point processes,
  implemented using custom-made MCMC algorithms, in Chapt. \ref{chapt.final}.

Finally, as mentioned in early on in this chapter, the Chapt. \ref {chapt.scr-unmarked} and \ref {chapt.partialID} deal with unmarked or
