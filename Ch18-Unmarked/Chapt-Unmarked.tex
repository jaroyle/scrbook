...
where ${\bf s}_i$ is the activity center of individual $i$.
...
In practice, population size, $N$, is never known. Estimating this %important
...
and so we favor the binomial prior because of its convienence.
