...
artificial mark that can be subsequently read in the field. For other
...
matrix of counts. It is worth contemplating how common such count data
is in
...
latent structure is that is provides a more mechanistic description
...
section. This ability to combine different
types of data should make it possible to
design effective monitoring programs when resources are too limited to
conduct extensive spatially extensive capture-recapture
studies, as has been done in
...
information. However, addition information such as home range size
