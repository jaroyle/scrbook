...
number of possible encounter histories that could give rise to the count
data will, in general, be too high to make the likelihood tractible,
...
count locations by 250 m and used $M=200$.

At this point in time the SC model can only be fit using one of the
\bugs~engines, or using custom software. Even the use of \bugs~is not
