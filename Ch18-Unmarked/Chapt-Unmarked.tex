...
\citep{sillett_etal:2012,royle_etal:2012}. In such a case, there is no
need to use spatially-explicit models such as
conditionally-autoregressive models or similar
\citep{besag_kooperber:1995,lichstein_etal:2002}.  The reason is that the
...
important is account for environmentally-induced spatial correlation
is in cases where correlation exists in the residuals
