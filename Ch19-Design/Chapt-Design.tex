...
Var(\hat{\bm \alpha})
\]
(matrix form of that copy from other document......)
We need to break this down into its constituent pieces:
(1) $Var(\hat{\bm \alpha})$. We don't actually know what this is --
but it seems reasonable to use a Poisson or Binomial GLM to
approximate it, since we have formulas for those.
...
\[
 \bar{p} = 1 - \sum_{s} exp(-\lambda_{0} \sum_{j} exp(b* d(x_{j}, s)))
\]
if we differentiate this with respect to $\lambda_{0}$ and $b$ we
have......
