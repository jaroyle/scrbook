...
individuals are
identifiable
upon encounter because they carry some form of individual mark. In Chapt. \ref{chapt.scr-unmarked} 
...
portion remains unidentifiable. 
...
the marked sample. While this is also an implicit assumption of capture-recapture models, in mark-resight this means that the process
of marking individuals requires careful consideration to actually produce a random sample.
This assumption is usually addressed by employing a
...
identifiable, while in the third scenario,
 part of the
