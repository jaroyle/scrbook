...
tackle that problem would be to estimate the number of marked and
unmarked individuals separately, using two sets of data augmentation
(i.e., estimating $\psi_{marked}$ and $psi_{unmarked}$), but with
shared detection parameters, $\sigma$ and $\lambda_0$.
