...
% ; and (2) where we assume that the distribution of marked individuals follows a bivariate normal distribution around the centriod of an array of marking locations (or, generally, an area over which animals were marked), $Xm_c$. 
