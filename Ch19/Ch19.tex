...
population studies (Morrison et al. 2008; Williams et al. 2003). There are probably few to no field biologists who have never been in the situation where a problem with data could be traced back to some flaw in study design. 
...
reanalyzing; Wegge et al. 2004; Tobler et al. 2008). The scarcity of simulation-based studies looking at study design issues is surprising, since  it seems natural to evaluate prescribed designs 
