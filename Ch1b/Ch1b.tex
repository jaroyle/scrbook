...
observed value $x$ is the outcome of some stochasitic process. For
example, $X$ could be the number of American shad (\emph{Alosa
...
region $B\inA$ is Poisson distributed with expectation $\lambda =
