...
[1] 7
\end{verbatim}
This is great. But of what use is it? Well, there are many. One very
...
expected value of the Poisson random variable, which may be a function
...
variable. The variance describes the amount of variation
around the expected value. Specifically, $\text{Var}(X) = \mathbb{E}[(X -
