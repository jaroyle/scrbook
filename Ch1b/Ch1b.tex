...
knowledge of statistics. Although it is critical to understand the
...
without a solid foundation in the fundamentals of statistical
inference.

In this chapter, we present a brief primer on key
statistical concepts that are referenenced throughout the remainder of
this book. For many readers, this material will be familiar,
perhaps even elementary, and thus some may want to skip to the next
...
various $F$-tests, which, although useful in some contexts, does not
...
\citet{link_barker:2010}. A very accessible introduction to these
materials is presented in Chapter XX of
\citet{mackenzie_etal:2005}. With all these excellent references, one
