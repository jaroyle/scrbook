...
The {\bf BUGS} dialects\footnote{We use this to mean {\bf WinBUGS}, {\bf OpenBUGS} and
...
%\begin{Verbatim}[commandchars=\\\{\}]  \mytilde  \end{Verbatim}
...
\end{verbatim}
 ...
 In the {\bf WinBUGS} output you see a column called ``Rhat''. This is the $\hat{R}$ statistic we introduced in \ref{glms.sec.convergence} to check whether the multiple chains converged (a value near 1 indicates satisfactory convergence). DIC is the
