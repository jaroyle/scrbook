...
XXX SOMETHING'S WRONG WITH THE FORMATTING XXXX
\begin{itemize}
...
or, for {\bf JAGS}, the  \mbox{\tt R2jags} \{su_yajima:2011} or 
...
here before we move on to implementing slightly more complex GL(M)M in a Bayesian framework.
...
\begin{figure}
\begin{center}
\includegraphics[height=2.75in]{Ch2-Bayes/figs/BUGSchains}
\end{center}
