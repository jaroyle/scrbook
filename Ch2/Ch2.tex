...
\begin{table}
\caption{Inference for binomial GLM with effects of survey time (alpha0) and geographic loation (alpha1 - alpha3) on mallard band recovery probabilities, fit using WinBUGS,
