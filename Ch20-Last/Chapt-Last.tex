...
spatial processes.
We talked about some of these in the book:
landscape connectivity, resource
...
of repulsion between home range centers. The idea is based on the notion
...
%in estimating population size. And thus far, 
%%Under a model with interaction between home range centers, 
%generated with interaction, the usual independence model has a
%%the misspecified independence model yields 
%%significant bias in the estimator of population size, and generally has larger
%%uncertainty for the population size than the proposed Strauss process
%%model.

While the Strauss model is interesting from a biological standpoint,
it 
