...
Recapitulation of the basic idea of putting a point process into an
ordinary capture-recapture model ............
Types of models we can fit.... covariates, etc....
Different observation models. ......
A big point: models of space usage and landscape connectivity. 
Dynamic models. 
Other things. 
...
In this book, 
we provided an overview and synthesis of what was currently known (or,
rather, published in the literature),
around the end of 2012, related to spatial capture-recapture methods. There
...
models. We envision that SCR models will be useful in helping
ecologists ``do science'' but developing explicit models of spatial
...
technical or methodological holes
in the lituerature (see previous section), and to make these methods
accessible to practiioners.
...
etc... This is a BFD.  [this is all recap of 2nd paragraph!]
