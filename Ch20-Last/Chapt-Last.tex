...
You've made it to the last chapter and we realize it's been a long journey to 
get here (congratulations)! Hopefully this book has provided you with many ideas on how 
to conduct ecological studies, address specific questions that were thought impossible
...
So where are we going? With these new sampling techniques, like many commonly used capture-recapture methods,
...
form. To address this issue, \citet{reich_etal:2012} develop an
