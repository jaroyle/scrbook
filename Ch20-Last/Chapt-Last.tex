...
is thrown into the trashcan).  % XXXX true dat!
As such, classical capture-recapture
models are really not the right tool for the job of analyzing real
data sets. % XXXX I would tone this down and say that "virtually all
...
Modeling dynamics of the point process. Transient individuals. Dispersal.
