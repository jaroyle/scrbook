...
% XXXX RC: Why the massive space here?
\vspace{2in}
...
get here. Congratulations! %(congratulations)!
...
Let us first briefly consider how we got here. Over a century ago, capture-recapture
...
capture-recapture models began to grow rapidly %more and more
...
%species,
mustelids such as weasels (Fig. \ref{last.fig.weasels}),
...
sampling methods,
%auxiliary
spatial information about location of capture is collected. %As such, c
Classical capture-recapture
models ignore this information, and in doing so fail to provide a
formal method for modeling spatial variation in density and encounter
...
This prediction is based on the fact % that by explicitly linking the space occupied by individuals with the
...
%developments of spatial capture-recapture models. The
the ``big idea'' of SCR,
...
be possible.  %could we add something like: similar to density estimation
