...
underlying point process is deffined -- the state-space of the point
process.  This state-space is {\it not} the ``effective sampled area''
-- it is desireable that it be somewhat larger than that in the sense
...
estimate or otherwise characterize the ESA explicitlly.
