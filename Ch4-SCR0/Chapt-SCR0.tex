...
% About D(x) -- I agree. We could have that generality. I'll add text
...
We have emphasized in this chapter that our basic ``model SCR0''
is an ordinary capture-recapture model for
...
point process. Part of the promise, and ongoing challenge, of SCR
