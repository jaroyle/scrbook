...
{\bf XXXX This function needs changed on the repo. edits made in-text
  here  XXXXX}
The 
...
out <- bugs (data, inits, parameters, "SCR0b.txt", n.thin=1,chains=3,
...
overlaps the data-generating value substantially. {\bf XXX possible
  plot here of posterior summaries XXXXX}
