...
its expected value \citep{efford_fewster:2012}. The distinction
between these two has to do with the scope of inference. On one hand,
if we care only about a specific population, or {\it the} population
...
and expected value applies to {\it density} as well. Realized density
