...
desireable that it be somewhat  larger than that in the sense
that individuals at the edge of the state-space have no probability of
being captured, but as part of the SCR model we don't need to try to estimate
...
\[
  ESA = a*\sum_{s} \Pr(\mbox{encounter} | {\bf s}) 
\]
...
For the wolverine I will produce the resutl here.....
