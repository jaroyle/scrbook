...
of the model, $\alpha_{0} = \mbox{logit}(p_{0})$, $\theta$ and $\psi$.  It remains to define the
...
parameter $\theta$ directly into the home range radius (sec. 
...
translates into a home range area of XXXX. 
