...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=6in,height=2.14in]{Ch4/figs/Mh_buffer}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[height=4.22in,width=3.2in]{Ch4/figs/Wolverines_cameratrap}
\end{center}
\caption{
...
\begin{figure}
\begin{center}
\includegraphics[height=5.75in,width=3.5in]{Ch4/figs/wolvDensity}
\end{center}
