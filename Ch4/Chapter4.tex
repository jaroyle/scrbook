...
sec. \ref{scr0.sec.unknownN} and then we fitted 4 models to it. In
addition to the Gaussian and exponential models we also fit the
complementary log-log model (``hazard model'') and the logit model
with the square of distance. We modified the function \mbox{\tt
  SCR0bayes} for this purpose.

We ask: What is the ESA under these?

       [,1]   [,2]   [,3]   [,4]
alpha0  -2.57  -2.60  -1.51  -0.47
alpha1   2.46   2.56   3.59   3.86
N  113.62 114.16 119.69 118.29
D   1.78   1.78   1.87   1.85
sigma  0.46   0.45   0.28   --
hra    3.85   3.70   5.51   2.64
