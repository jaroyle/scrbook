...
We modified exactly XXXX code to fit the Poisson model
contained in  \mbox{\tt wolvSCR0pois.fn} and you can read the helpfile
for the {\bf R} code that produces the following results which we
provide 
in Tab. XX a side-by-side comparison of the difference between the two models....
