...
technical details of this, but there is a slight difference in that
...
likelihood is $\Phi(\gamma)$ (see Eq. 8 from \citet{efford_etal:2009ecol}):
\[
\Pr(y_{ij}| {\bf u}_{i} ) = \Phi( \gamma( stuff) )^{1-y_{ij}}
\mbox{Normal}(y_{ij};\alpha_{0},\alpha_{1},\sigma_{s},{\bf x}_{j},{\bf
u}_{i})^{y_{ij}}
\]
