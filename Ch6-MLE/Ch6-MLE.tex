...
\subsubsection{Model averaging and testing}

\mbox{\tt secr} has a population closure test .....

\mbox{\tt secr} does likelihood ratio tests to compare fitted models.....

\mbox{\tt secr} will produce model selection tables based on AIC or
AICc, and will produce model-averaged parameter estimates (See sec. XXXXX).
...
traps, or for the entire trap array. 
 ...
 the locations of one or more individual activity centers (as in Sec. XXXXXX).
...
of default types of covariates in Chapt. \ref{XXX} and also see
Chapt. \ref{chapt.gof} for more examples. But what if you have a
covariate of some sort that isn't one of the pre-defined?
