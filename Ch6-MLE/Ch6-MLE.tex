...
\subsection{Restricted state-space or Habitat mask}
...
For each point in the state-space grid, we deterimine whether it is
...
Here
are the {\bf R} commands for doing this:  {\bf XXXX a few commands
  need changed in the repo help file for intlik4 XXXXX}
{\small
\begin{verbatim}
library(maptools}
library(sp)
