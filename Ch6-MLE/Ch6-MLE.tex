...
specify any arbitrary covariate as an effect, which is added to a
capthist object somehow and specified according to the standard model
syntax XXXXXX.
...
modifying the density model in secr.fit. e.g., \verb+D ~ 1+ is a
constant density surface, \verb#D ~ x + y# is a linear response
