...
Therefore, we take the following 3 components: (1) the marginal
...
mixture â€“ precisely an occupancy type model \citep{royle:2006}.
...
makes use of the
standard {\bf R} model specification framework with tildes, e.g., the model
...
XXXX This next par here should ref ahead to Chapt. 9 where the table is  XXXXX

The package \mbox{\tt secr} offers a large number of different detection
