...
\citep[][Appendix F4]{williams_etal:2003}
\footnote{
...
To evaluate the effect of the intergration grid density, 
...
grid as an explict argument, and this function is also available in
...
the present case (the calcuation above) we used a state-space grid
