...
interpretation of $\sigma$.  The estimate (posterior mean) of $\sigma$ under the negative exponential model is
...
estimates (posterior means) are similar to the base model, likely because the
