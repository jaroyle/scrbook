...
\begin{equation}
\sigma^2|\mu,y \sim InvGamma (a_n, b_n),
...
\citep[sect. 6.4.1 in][]{robert_casella:2010}. You will see plenty of examples of
...
For $\sigma_{\alpha}^2$ we use $\sigma_{\alpha}^2^{(1)}\sim Inverse-Gamma (a_n, b_n)$,
