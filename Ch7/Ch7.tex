...
\begin{comment}
 Andy: should I remove part of the code from the text -- maybe just show the updating of alpha -- and put the full code into the R package?
\end{comment}
{\small
\begin{verbatim}
Pois.reg<-function(y=y,site=site,mu0=mu0,sig0=sig0,a0=a0,b0=b0, 
mu_beta=mu_beta, sig_beta=sig_beta, delta_alpha=delta_alpha, 
delta_beta=delta_beta, niter=niter){
