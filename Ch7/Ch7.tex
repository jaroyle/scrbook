...
XXXX In some simple cases we can adjust the state space by setting one of the
...
\begin{figure}
\begin{center}
\includegraphics[height=2.5in]{Ch7/figs/raccooncamera}
\end{center}
