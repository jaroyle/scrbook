...
For Bayesian analysis we rely on different methods. We use the Kuo and
Mallick idea \citep{kuo_mallick:1998}, 
sometimes DIC although we are kind of against it for
some reasons (see below).......
There is a good review paper recently by \citet{ohara_sillanpaa:2009}
that hits on these and many more. 
