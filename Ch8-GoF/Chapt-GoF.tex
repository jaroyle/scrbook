...
effort: (1) Choosing among biological models and (2) choosing among
different parametric encounter probability models. 

\subsubsection{Choosing Biological models}

Behavior, time of year, trap type (biated or not), seasonal variation
in encounter probability, things that make a
biological difference we should be able to choose among and these are
probably secondary interests 
in many capture-recaptuer studies, or secondary to estimating density
at least.
In terms of a given problem of density estimation, 
the expectation is that it should make a big difference for covariate
effects such as behavioral response and so forth which has been demonstrated in
practice repeatedly. So we need to be able to make objective choices
to deciding what should be in the model and what should not. 

\subsubsection{Choosing detection models}
