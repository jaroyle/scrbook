...
% XXXX have
addressed the problem of estimation, %XXXX extensively,
and also making
predictions of latent variables, either ${\bf s}$ or
% XXXX Something about this sentence seems gramatically incorrect
...
to 0.  % XXXX Is this last sentence a fragment?
...
as follows:
% XXXX Did we decide to capitalize? {\tt SEX}???
\[
...
is a mixture of % XXXX being
draws from the prior and draws % XXXX being
informed by
