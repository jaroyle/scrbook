...
the activity centers is adequate.  We used the \mbox{\tt wolvSCR0gof}
function to fit one of the models from our model that that includes
full sex-specificity of parameters.
...
XXXX RUNNING 12/17/2012 XXXXXXXXXXXXXXXXXXXXXXXXX

XXX WRONG FUNCTION CALL

toad1<-wolvSCR0gof(y3d,traps,wsex=wsex,nb=1000,ni=2000,buffer=2,M=200,model=1)
