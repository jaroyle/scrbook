...
XXXX
need to run WinBUGS to check
XXXX
need to run different priors. 
}

The {\bf BUGS} model specification for model 4 is shown in panel XXXX. We
...
for(i in 1:M){
 ...
 log(sigma.vec[i])<- log(sigma) + beta.sex*wsex[i]
...
XXX this will be in a table XXXXX
...
parameter     model 1          model 2      model 3           model 4
          mu.vect sd.vect 
D           5.776   1.121   5.723   1.136    5.714   1.145  D           5.677   1.156 
N          59.925  11.627  59.370  11.790   59.275  11.874  N          58.892  11.995 
alpha0     -2.816   0.175  -2.439   0.248   -2.813   0.176  alpha0     -2.420   0.259 
alpha.sex   0.003   1.735  -0.743   0.343    0.001   1.732  alpha.sex  -0.810   0.358 
beta        1.246   0.208   1.190   0.206    1.222   0.296  beta        1.295   0.334 
beta.sex   -0.013   1.733   0.009   1.741   -0.012   0.172  beta.sex    0.087   0.187 
sigma       0.640   0.054   0.656   0.059    0.654   0.083  sigma       0.639   0.093 
psi         0.302   0.066   0.299   0.066    0.298   0.067  psi         0.297   0.068 
psi.sex     0.520   0.102   0.561   0.102    0.524   0.108  psi.sex     0.543   0.112 
deviance  441.731  12.499 439.814  12.516  443.285  12.661 deviance  441.272  12.743 
...
> toad5<-wolvSCR0ms.fn(y3d,traps,wsex=wsex,nb=1000,ni=21000,delta=2,M=200,model=5,parm="a")
...
X1new       9.749   2.749   5.220   7.775   9.476  11.414  15.907 1.001 60000
X1obs      12.625   3.376   7.055  10.214  12.279  14.652  20.162 1.001 12000
X3new      13.145   3.239   7.657  10.823  12.863  15.149  20.264 1.001 48000
X3obs      21.253   2.099  17.706  19.773  21.059  22.519  25.947 1.003  1200
Xnew       61.993   6.585  49.762  57.391  61.773  66.325  75.435 1.002  3000
Xobs       89.062   6.053  77.987  84.848  88.782  92.973 101.710 1.002  1400
...
logitp0    -2.579   0.285  -3.082  -2.791  -2.595  -2.380  -2.004 1.001  5000
...
\subsection{Adequacy of Encounter Probability Model}

We first considewr the case 
...
\]
This is conditional on ${\bf s}$ and conditional on the data
