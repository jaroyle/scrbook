...
XXXXXXXXXXXXXXXXXXXXXXXXXXXX
- check on greek letters for secr detection function table
- check on section for ``see sec. gof.sec.XXXXX'' comment
-Fix  "royle_etal:2009jwm" and "royle_etal:2009"
...
global \citep{gardner_etal:2010jwm} or local  \citep{royle_etal:2009jwm}.
...
%This coding of session allows us
%to compare all the models via AIC. A model set which contains both
%multi-session and single-session models 
% XXXX I THINK THIS NEEDS TO BE
%EXPLAINED A BIT BETTER XXXX.  
