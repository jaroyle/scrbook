...
We deal with this slightly differently based on the framework
...
latex tag here XXXX
using {\bf JAGS}for the equivalent detection model. XXXX how different
...
to fit in {\bf JAGS}.  The package \secr only fits XXXX is this true?
...
rather easily.  Without reorganizing our data, we can just take
...
To fit a trap specific behavioral response, we use just slightly modify the
