...
XXX HOW COME YOU STICK TO THE CLOGLOC HERE? XXX
...
the model in the exact same form as above (with the sole difference that both $C$ and $p$ are now also indexed by $k$):
\[
...
XXXX BETH; NOT SURE WHY THIS IS IN HERE TWICE; ARE YOU GONNA USE ANY OF THE SECOND BEHAVIOR SECTION? XXXXX
XXXX ALSO NEED TO FILL IN RESULTS FOR THE BLACK BEAR ANALYSIS HERE - RUNNING XXXXX
...
Specifying a fully sex specific model for {\bf JAGS} is very similar to the time-specific model shown above: 
...
XXXXX BETH I THINK WE SHOULD MOVE THE TABLE WITH THE DETECTION FUNCTIONS DOWN HERE XXXXX
