...
% this next bit is not true.............
%, as long as detection decreases
%with distance (otherwise $N$ would be unidentifiable). 
The most
...
{\bf XXXX could you change this
  to the explicit use of dummy variables, say called \mbox{\tt
    Type}?????? This is preferable in the text descriptions I think,
  but you can say that for implementing this in WinBUGS we use the
  index variable method XXXXXXXXXXXX}
...
{\bf XXXX Again please use a dummy variable here maybe? XXXXXXXXXXXXXXXXXXXXXXXX}
\begin{eqnarray*}
...
XXXXXXXXXXXX
could model covariates on the sigma-scale directly. Given that
posterior is not invarianet to transformation of parameters this could
have a big effect
XXXXXXXXXXXXX
