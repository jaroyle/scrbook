...
if we had many sampling occasions, take the wolverine example from Chapt. \ref{scr0.sec.wolverine}
where there were 165 daily sampling
occasions).  In some cases, such as the wolverine study, 
we might sample over longer time frames and
expect the date to have a strong impact on encounter for a variety of reasons.  For
