...
\hl{use R2Cuba instead of int2d}
...
\hl{add this code to the R package help file for scrIPP}
...
\hl{FIXME. I think the grid points are slightly different in the secr and
  jags datasets. Might explain slight differences}
