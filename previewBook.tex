...
\usepackage{lineno}
\usepackage{natbib}
\usepackage[pdftex,pdfstartview=FitH,pdfpagemode=UseNone,linkbordercolor={1 1 1},citebordercolor={1 1 1}]{hyperref}
\usepackage{verbatim}
\usepackage{soul}
\usepackage{color}
\usepackage{fancyvrb}
...
\hspace*{-.166in}{\LARGE Foreword} \\

\vspace*{.2in}

\addcontentsline{toc}{chapter}{Foreword}
\input{Ch0-Foreword/Foreword}
...
\input{Ch3-Bayes/Chapt-Bayes.tex}
